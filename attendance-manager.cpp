...
int registerStudent()
{
    ...
    cin.getline(add, 100);
    cout << "\nEnter Father's Name: ";
    getchar(); cin.getline(fathersname, 100);
    cout << "\nEnter Mother's Name: ";
    getchar(); cin.getline(mothersname, 100);
